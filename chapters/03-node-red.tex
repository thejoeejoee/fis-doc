...
\begin{itemize}
    ...
    Node-RED -- vytváří jednosměrný tunel pro mezi-síťové směřování zpráv.
\end{itemize}
...
\texttt{node-red-dashboard}. Tento balíček nabízí tvůrcům sítí zařadit i uživatelské rozhraní zahrnující dynamické
