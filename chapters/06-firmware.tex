...
Firmware z hlediska správy aplikací rozlišuje pohledy na ně -- v prvním případě se jedná o aplikace dostupné k
použití, reference na konkrétní třídy aplikací má uložené ve slovníku \ic{APPS} dostupném z modulu \texttt{fis.apps}.
...
startu přímo zavedena konfigurační aplikace zodpovědná za správnu ostatních aplikací -- její detaily budou popsány v
kapitole \ref{sec:konfiguracni-aplikace}.
