...
\begin{figure}
    \begin{minipage}{\textwidth}
        ...
        data.]{
        \includegraphics[valign=t,width=.45\textwidth]{figures/messages-in-time-publisher.pdf}
        }\hfill%
        ...
        \includegraphics[valign=t,width=.45\textwidth]{figures/messages-in-time-subscriber.pdf}
        }
    \end{minipage}
    \begin{minipage}{\textwidth}
        \vspace{1.5em}
        ...
        \includegraphics[valign=t,width=.45\textwidth]{figures/messages-in-time-timeout.pdf}
        }
    \end{minipage}
