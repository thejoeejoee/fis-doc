...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{s|l|s}
        ...
        \hline
        \ic{fis/from/25a8ced/status} & \json{\{"online": true\}} & uzel s identifikátorem \uv{25a8ced} oznamuje změnu
        svého stavu -- své připojení \\
        \hline
        \ic{fis/from/25a8ced/app/74cae6f} & \json{\{"value": 0.3745\}} & aplikace s identifikátorem \uv{74cae6f} publikuje
